...
import aplicacion.vista.EliminarAdmin;
import java.awt.BorderLayout;
import javax.swing.JPanel;

public class ElimDept extends javax.swing.JPanel {

    EliminarAdmin elim1 = new EliminarAdmin();
    
    public ElimDept() {
        initComponents();
        
        ShowPanel(elim1.ElimDept);
    }
    ...
    private void initComponents() {
        ...
        lblAccion.setText("Eliminar Departamento");
        jPanel2.add(lblAccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 210, -1));
