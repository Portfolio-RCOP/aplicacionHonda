...
public class ElimDirEmp extends javax.swing.JPanel {

    EliminarAdmin elim2 = new EliminarAdmin();
    
    public ElimDirEmp() {
        initComponents();
        
        ShowPanel(elim2.ElimDirEmp);
    }
    ...
    private void initComponents() {
        ...
        lblAccion.setText("Eliminar Dirección de Empleado");
