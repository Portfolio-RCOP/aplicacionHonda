 ...
 * @author Usuario
 */
public class PageIniGAd extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        contentIni.add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 230, 50));

        lblBienv.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lblBienv.setText("Bienvenido a Honda Pacífico");
        contentIni.add(lblBienv, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 240, -1));

        lblUsername.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        lblUsername.setText("Usuario: ");
        contentIni.add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 410, 40));
        ...
        btnCSesion.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        btnCSesion.setForeground(new java.awt.Color(255, 255, 255));
        btnCSesion.setText("Cerrar Sesión");
        contentIni.add(btnCSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 230, 130, 40));
    ...
    public javax.swing.JButton btnCSesion;
    public javax.swing.JPanel contentIni;
